...
//                        }
//                    }
//                    Toast.makeText(this@ContactsFragment, "$id $name $phoneNumber", Toast.LENGTH_LONG).show()
//                }
//                Toast.makeText(this@ContactsFragment, "read all the contacts", Toast.LENGTH_LONG).show()
//            } else {
//                Toast.makeText(this@ContactsFragment, "No ContactsFragment in the phone", Toast.LENGTH_LONG).show()
//            }
